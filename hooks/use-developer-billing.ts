...
export type DeveloperSubscription = { id: string; organization_id: string; plan_id: string; status: string; contract_paid: number; sandbox_active: number; current_period_start: string; current_period_end: string; auto_renew: number; code: string; name: string; inventory_limit: number; monthly_price_uzs: number };
