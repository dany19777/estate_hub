...
const emptyData: AdminBillingData = { plans: [], subscriptions: [], config: null, secondaryListings: [], events: [], stats: { revenue: 0, activeSubscriptions: 0, activeSecondary: 0, expiringSecondary: 0 } };
