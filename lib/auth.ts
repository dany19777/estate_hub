...
export type Permission = 'VIEW_DEVELOPER_DASHBOARD' | 'MANAGE_COMPLEXES' | 'MANAGE_UNITS' | 'VIEW_ADMIN' | 'REVIEW_VERIFICATION' | 'MODERATE_LISTINGS';
...
const platformPermissionMatrix: Record<PlatformRole, Permission[]> = {
  SUPERADMIN: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES', 'MANAGE_UNITS', 'VIEW_ADMIN', 'REVIEW_VERIFICATION', 'MODERATE_LISTINGS'],
  PLATFORM_ADMIN: ['VIEW_ADMIN', 'REVIEW_VERIFICATION', 'MODERATE_LISTINGS'],
  MODERATOR: ['VIEW_ADMIN', 'MODERATE_LISTINGS'],
  VERIFICATION_SPECIALIST: ['VIEW_ADMIN', 'REVIEW_VERIFICATION'],
  FINANCE_OPERATOR: ['VIEW_ADMIN'],
  SUPPORT: ['VIEW_ADMIN'],
  CONTENT_MANAGER: ['VIEW_ADMIN'],
};

const organizationPermissionMatrix: Record<OrganizationRole, Permission[]> = {
  OWNER: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES', 'MANAGE_UNITS'],
  ADMIN: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES', 'MANAGE_UNITS'],
  HEAD_OF_SALES: ['VIEW_DEVELOPER_DASHBOARD'],
  MANAGER: ['VIEW_DEVELOPER_DASHBOARD'],
