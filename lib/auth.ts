...
export type Permission = 'VIEW_DEVELOPER_DASHBOARD' | 'MANAGE_COMPLEXES' | 'MANAGE_UNITS' | 'MANAGE_LEADS' | 'VIEW_ADMIN' | 'REVIEW_VERIFICATION' | 'MODERATE_LISTINGS' | 'MANAGE_FINANCE';
...
const platformPermissionMatrix: Record<PlatformRole, Permission[]> = {
  SUPERADMIN: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES', 'MANAGE_UNITS', 'MANAGE_LEADS', 'VIEW_ADMIN', 'REVIEW_VERIFICATION', 'MODERATE_LISTINGS', 'MANAGE_FINANCE'],
  PLATFORM_ADMIN: ['VIEW_ADMIN', 'REVIEW_VERIFICATION', 'MODERATE_LISTINGS', 'MANAGE_FINANCE'],
  MODERATOR: ['VIEW_ADMIN', 'MODERATE_LISTINGS'],
  VERIFICATION_SPECIALIST: ['VIEW_ADMIN', 'REVIEW_VERIFICATION'],
  FINANCE_OPERATOR: ['VIEW_ADMIN', 'MANAGE_FINANCE'],
  SUPPORT: ['VIEW_ADMIN'],
  CONTENT_MANAGER: ['VIEW_ADMIN'],
};

const organizationPermissionMatrix: Record<OrganizationRole, Permission[]> = {
  OWNER: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES', 'MANAGE_UNITS', 'MANAGE_LEADS'],
  ADMIN: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES', 'MANAGE_UNITS', 'MANAGE_LEADS'],
  ...
  FINANCE: ['VIEW_DEVELOPER_DASHBOARD'],
