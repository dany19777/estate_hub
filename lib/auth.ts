...
export type Permission = 'VIEW_DEVELOPER_DASHBOARD' | 'MANAGE_COMPLEXES' | 'VIEW_ADMIN' | 'REVIEW_VERIFICATION';
...
const platformPermissionMatrix: Record<PlatformRole, Permission[]> = {
  SUPERADMIN: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES', 'VIEW_ADMIN', 'REVIEW_VERIFICATION'],
  PLATFORM_ADMIN: ['VIEW_ADMIN', 'REVIEW_VERIFICATION'],
  MODERATOR: ['VIEW_ADMIN'],
...
const organizationPermissionMatrix: Record<OrganizationRole, Permission[]> = {
  OWNER: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES'],
  ADMIN: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES'],
  HEAD_OF_SALES: ['VIEW_DEVELOPER_DASHBOARD'],
  MANAGER: ['VIEW_DEVELOPER_DASHBOARD'],
  CONTENT_MANAGER: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES'],
