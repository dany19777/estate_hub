...
export type Permission = 'VIEW_DEVELOPER_DASHBOARD' | 'MANAGE_COMPLEXES' | 'MANAGE_UNITS' | 'MANAGE_LEADS' | 'VIEW_ADMIN' | 'REVIEW_VERIFICATION' | 'MODERATE_LISTINGS';
...
const platformPermissionMatrix: Record<PlatformRole, Permission[]> = {
  SUPERADMIN: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES', 'MANAGE_UNITS', 'MANAGE_LEADS', 'VIEW_ADMIN', 'REVIEW_VERIFICATION', 'MODERATE_LISTINGS'],
