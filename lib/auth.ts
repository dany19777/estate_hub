...
export type Permission = 'VIEW_DEVELOPER_DASHBOARD' | 'MANAGE_COMPLEXES' | 'MANAGE_UNITS' | 'MANAGE_LEADS' | 'VIEW_ADMIN' | 'REVIEW_VERIFICATION' | 'MODERATE_LISTINGS' | 'MANAGE_FINANCE' | 'MANAGE_BILLING' | 'MANAGE_PROMOTIONS';
...
const platformPermissionMatrix: Record<PlatformRole, Permission[]> = {
  ...
  PLATFORM_ADMIN: ['VIEW_ADMIN', 'REVIEW_VERIFICATION', 'MODERATE_LISTINGS', 'MANAGE_FINANCE', 'MANAGE_BILLING', 'MANAGE_PROMOTIONS'],
  MODERATOR: ['VIEW_ADMIN', 'MODERATE_LISTINGS'],
  VERIFICATION_SPECIALIST: ['VIEW_ADMIN', 'REVIEW_VERIFICATION'],
  FINANCE_OPERATOR: ['VIEW_ADMIN', 'MANAGE_FINANCE', 'MANAGE_BILLING', 'MANAGE_PROMOTIONS'],
  SUPPORT: ['VIEW_ADMIN'],
  CONTENT_MANAGER: ['VIEW_ADMIN'],
};

const organizationPermissionMatrix: Record<OrganizationRole, Permission[]> = {
  OWNER: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES', 'MANAGE_UNITS', 'MANAGE_LEADS', 'MANAGE_BILLING', 'MANAGE_PROMOTIONS'],
  ADMIN: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES', 'MANAGE_UNITS', 'MANAGE_LEADS', 'MANAGE_BILLING', 'MANAGE_PROMOTIONS'],
  HEAD_OF_SALES: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_LEADS'],
  MANAGER: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_LEADS'],
  CONTENT_MANAGER: ['VIEW_DEVELOPER_DASHBOARD', 'MANAGE_COMPLEXES', 'MANAGE_UNITS', 'MANAGE_PROMOTIONS'],
