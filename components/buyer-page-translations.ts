...
Object.assign(phrases, {
  'Написать застройщику': { uz: 'Quruvchiga yozish', en: 'Message developer' },
  'Не удалось загрузить проверку входа.': { uz: 'Kirish tekshiruvini yuklab bo‘lmadi.', en: 'Could not load sign-in verification.' },
  'Не удалось создать ключ MFA.': { uz: 'MFA kalitini yaratib bo‘lmadi.', en: 'Could not create an MFA key.' },
  'Не удалось скопировать ключ. Выделите его и скопируйте вручную.': { uz: 'Kalitdan nusxa olib bo‘lmadi. Uni belgilab qo‘lda nusxalang.', en: 'Could not copy the key. Select and copy it manually.' },
  'Не удалось скопировать коды. Выделите их и скопируйте вручную.': { uz: 'Kodlardan nusxa olib bo‘lmadi. Ularni belgilab qo‘lda nusxalang.', en: 'Could not copy the codes. Select and copy them manually.' },
  'Неверный код.': { uz: 'Kod noto‘g‘ri.', en: 'Invalid code.' },
  'Не удалось проверить код.': { uz: 'Kodni tekshirib bo‘lmadi.', en: 'Could not verify the code.' },
  'Подтверждение входа': { uz: 'Kirishni tasdiqlash', en: 'Verify sign-in' },
  'Доступ к кабинету платформы защищён одноразовым кодом из приложения-аутентификатора.': { uz: 'Platforma kabinetiga kirish autentifikator ilovasidagi bir martalik kod bilan himoyalangan.', en: 'Access to the platform dashboard is protected by a one-time code from an authenticator app.' },
  'Локальный тестовый вход: код показан прямо на этой странице.': { uz: 'Mahalliy sinov kirishi: kod shu sahifada ko‘rsatiladi.', en: 'Local test sign-in: the code is shown on this page.' },
  'Тестовый код для входа:': { uz: 'Kirish uchun sinov kodi:', en: 'Test sign-in code:' },
  'Подождите несколько секунд…': { uz: 'Bir necha soniya kuting…', en: 'Please wait a few seconds…' },
  'Введите эти 6 цифр в поле ниже. Код обновляется автоматически каждые 30 секунд. Приложение на телефоне сейчас не требуется.': { uz: 'Ushbu 6 raqamni quyidagi maydonga kiriting. Kod har 30 soniyada avtomatik yangilanadi. Hozir telefon ilovasi kerak emas.', en: 'Enter these 6 digits in the field below. The code updates automatically every 30 seconds. No phone app is needed for this test.' },
  'Шестизначный тестовый код': { uz: 'Olti xonali sinov kodi', en: 'Six-digit test code' },
  'Проверяем настройки MFA…': { uz: 'MFA sozlamalari tekshirilmoqda…', en: 'Checking MFA settings…' },
  'Создаём ключ…': { uz: 'Kalit yaratilmoqda…', en: 'Creating key…' },
  'Настроить приложение-аутентификатор': { uz: 'Autentifikator ilovasini sozlash', en: 'Set up authenticator app' },
  'Шаг 1.': { uz: '1-qadam.', en: 'Step 1.' },
  'Откройте приложение-аутентификатор на телефоне и выберите «Добавить аккаунт» → «Ввести ключ вручную».': { uz: 'Telefoningizdagi autentifikator ilovasini oching va «Hisob qo‘shish» → «Kalitni qo‘lda kiritish»ni tanlang.', en: 'Open your authenticator app and choose “Add account” → “Enter setup key manually”.' },
  'Название аккаунта: EstateHub (': { uz: 'Hisob nomi: EstateHub (', en: 'Account name: EstateHub (' },
  '). Тип ключа: по времени (TOTP).': { uz: '). Kalit turi: vaqtga asoslangan (TOTP).', en: '). Key type: time-based (TOTP).' },
  'Ключ настройки — его не нужно вводить в поле ниже:': { uz: 'Sozlash kaliti — uni quyidagi maydonga kiritmang:', en: 'Setup key — do not enter it in the field below:' },
  'Ключ скопирован': { uz: 'Kalit nusxalandi', en: 'Key copied' },
  'Скопировать ключ': { uz: 'Kalitdan nusxa olish', en: 'Copy key' },
  'Шаг 2.': { uz: '2-qadam.', en: 'Step 2.' },
  'Сохраните аккаунт в приложении. Оно покажет шестизначный код, который меняется каждые 30 секунд. Введите именно этот код в поле ниже.': { uz: 'Hisobni ilovada saqlang. Ilova har 30 soniyada yangilanadigan olti xonali kodni ko‘rsatadi. Aynan shu kodni quyidagi maydonga kiriting.', en: 'Save the account in the app. It will show a six-digit code that changes every 30 seconds. Enter that code below.' },
  'Одноразовый резервный код': { uz: 'Bir martalik zaxira kod', en: 'One-time recovery code' },
  'Шестизначный код из приложения-аутентификатора': { uz: 'Autentifikator ilovasidagi olti xonali kod', en: 'Six-digit code from authenticator app' },
  'Подтвердить вход': { uz: 'Kirishni tasdiqlash', en: 'Verify sign-in' },
  'Ввести код из приложения': { uz: 'Ilovadagi kodni kiritish', en: 'Enter app code' },
  'Использовать резервный код': { uz: 'Zaxira koddan foydalanish', en: 'Use a recovery code' },
  'Сохраните резервные коды.': { uz: 'Zaxira kodlarni saqlang.', en: 'Save your recovery codes.' },
  'Каждый из них действует только один раз, если вы потеряете доступ к приложению-аутентификатору. После ухода с этой страницы коды больше не появятся.': { uz: 'Autentifikator ilovasiga kirish imkonini yo‘qotsangiz, har bir koddan faqat bir marta foydalanish mumkin. Bu sahifadan chiqqach kodlar qayta ko‘rsatilmaydi.', en: 'Each code can be used once if you lose access to your authenticator app. They will not be shown again after you leave this page.' },
  'Коды скопированы': { uz: 'Kodlar nusxalandi', en: 'Codes copied' },
  'Скопировать все коды': { uz: 'Barcha kodlardan nusxa olish', en: 'Copy all codes' },
  'Я сохранил коды — открыть кабинет': { uz: 'Kodlarni saqladim — kabinetni ochish', en: 'I saved the codes — open dashboard' },
  'Вернуться ко входу': { uz: 'Kirish sahifasiga qaytish', en: 'Back to sign-in' },
  'Создать тестовую бронь на 72 часа без оплаты? Квартира станет недоступной для других покупателей.': { uz: 'Kvartirani 72 soatga to‘lovsiz sinov tariqasida band qilasizmi? U boshqa xaridorlar uchun mavjud bo‘lmaydi.', en: 'Create a 72-hour test reservation without payment? The apartment will become unavailable to other buyers.' },
  'Не удалось создать бронь.': { uz: 'Band qilishni yaratib bo‘lmadi.', en: 'Could not create the reservation.' },
  'Тестовая бронь создана.': { uz: 'Sinov band qilish yaratildi.', en: 'Test reservation created.' },
  'Открыть мою бронь': { uz: 'Band qilishimni ochish', en: 'Open my reservation' },
  'Бронируем…': { uz: 'Band qilinmoqda…', en: 'Reserving…' },
  'Тест: забронировать без оплаты': { uz: 'Sinov: to‘lovsiz band qilish', en: 'Test: reserve without payment' },
  'Только на localhost · срок 72 часа · деньги не списываются': { uz: 'Faqat localhostda · 72 soat · pul yechilmaydi', en: 'Localhost only · 72 hours · no charge' },
  'Отменить тестовую бронь? Квартира снова станет доступной.': { uz: 'Sinov band qilishni bekor qilasizmi? Kvartira yana mavjud bo‘ladi.', en: 'Cancel the test reservation? The apartment will become available again.' },
  'Не удалось отменить бронь.': { uz: 'Band qilishni bekor qilib bo‘lmadi.', en: 'Could not cancel the reservation.' },
  'Тестовая бронь отменена.': { uz: 'Sinov band qilish bekor qilindi.', en: 'Test reservation canceled.' },
  'Тестовая бронь': { uz: 'Sinov band qilish', en: 'Test reservation' },
  'Тестовая бронь без оплаты. Квартира удерживается до указанного срока.': { uz: 'To‘lovsiz sinov band qilish. Kvartira ko‘rsatilgan muddatgacha band turadi.', en: 'Test reservation without payment. The apartment is held until the stated deadline.' },
  'Отменить тестовую бронь': { uz: 'Sinov band qilishni bekor qilish', en: 'Cancel test reservation' },
  'Тестовый режим': { uz: 'Sinov rejimi', en: 'Test mode' },
  'Без оплаты': { uz: 'To‘lovsiz', en: 'No payment' },
});
